		...
		<div id="content" style="width:100%;">
		   ...
		   <div class="top-navbar">
              ...
              <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">Halaman Pemesanan</h4>  
                <!-- <ol class="breadcrumb">
  ...
  <div class="text-center tab-content" id="myTabContent">
	<div class="table-wrapper  tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" >
        ...
        <div class="row">
            ...
            <h2 class="ml-lg-2">Data Pemsanan</h2>
            </div>
        </div>
        </div>
           ...
           <?php $i = 1;  foreach($data_pesan as $rsp) {?>
            ...
            <tr>
              ...
              <?php } else { ?>
               ...
               <?php } ?>
               <th><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal<?php $rsp['nama_pemesan'] ?>" >Bukti Pemesanan</button></th>
               <th><a href="controller.php">Hapus</a></th>
            </tr>
            <?php  $i++; } ?>
        </tbody>
        </table>
...
<?php  foreach($data_pesan as $rsp) {?>
        <!-- Modal -->
        <div class="modal fade" id="exampleModal<?php $rsp['nama_pemesan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
                <!-- <input type="hidden" name="id_pemesan" > -->
                <input type="text" value="<?= $rsp['nama_pemesan'] ?>">
